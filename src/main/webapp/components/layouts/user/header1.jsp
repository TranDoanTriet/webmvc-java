	    ...
	    <div class="col">
	      <c:choose>
			    <c:when test="${not empty LoginInfo}">
			        ...
			        <a href="<c:url value="/authen/profile"/>" class="ml-1 txt-white">Profile</a>
			    </c:when>
			    <c:otherwise>
			        <a href="<c:url value="/authen/login"/>" class="txt-white">Log in</a>
			        <a href="<c:url value="/authen/sign-up"/>" class="ml-1 txt-white">Create an account</a>
			    </c:otherwise>
			</c:choose>
	    </div>
	...
	<div class="container">
	  <div class="row">
	     ...
	     <div class="col-4 txt-end">
	     		<form action="/final_project/search" method="get">
			     	<div class="row">
			     		<div class="col-10">
			     			<input type="text" class="form-control" id="inputSearch" name="keyword" placeholder="Enter product name">
			     		</div>
			     		<div class="col-2">
		      	...
		      	<div class="txt-center mt-1 txt-start">
